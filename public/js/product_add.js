...
$(document).ready(function() {
    ...
    $("#save_product_db").on('click', function(){
        ...
        if(!input_buff_product_gl){ $("#input_buff_product").addClass("user-input-err-1"); alert("Пусто");} else { alert("не пусто");$("#input_buff_product").append( '<p class="price-item-bold">Добавьте цену</p>'); }
