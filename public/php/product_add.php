...
$sql = "INSERT INTO `products`(`name`, `detail`, `datetime_start`, `datetime_stop`, `type`, `country`, `valute`, `period_job`,
                    ...
                    '". $_POST['days_job_bilet'] ."','1','1','". $_POST['res_date_start_sell'] ."','". $_POST['int_price_bilet'] ."','". $_POST['int_old_price_bilet'] ."','2". $_POST['res_parse_start_access'] ."',
                    '". $_POST['res_parse_stop_access'] ."','2024-08-28 15:37:32','[value-18]','[value-19]','[value-20]','[value-21]', '2024-08-28 15:37:32');";
