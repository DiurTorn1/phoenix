...
if ($conn->connect_error) {
  die("Connection failed: " . $conn->connect_error);//int_price_bilet
}
...
$sql = "INSERT INTO `products`(`name`, `detail`, `datetime_start`, `datetime_stop`, `type`, `country`, `valute`, `period_job`,
                    ...
                    '". $_POST['days_job_bilet'] ."','1','1','". $_POST['res_date_start_sell'] ."','". $_POST['int_price_bilet'] ."','1','2024-08-28 15:37:32',
