...
$sql = "INSERT INTO `products`(`name`, `detail`, `datetime_start`, `datetime_stop`, `type`, `country`, `valute`, `period_job`,
                    ...
                    `datetime_stop_sell`, `img_main`, `img_banner`, `img_video_promo`, `video_promo`, `created_at`) VALUES ('". $_POST['head_name'] ."','[value-3]',
                    '". $_POST['start_access_time'] ." 00:00:00','2024-08-28 15:37:32','[value-6]','[value-7]','[value-8]','1','1','1','2024-08-28 15:37:32','1','1','2024-08-28 15:37:32',
