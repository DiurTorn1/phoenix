...
$sql = "INSERT INTO `products`(`name`, `detail`, `datetime_start`, `datetime_stop`, `type`, `country`, `valute`, `period_job`,
                    ...
                    '". $_POST['days_job_bilet'] ."','". $_POST['int_input_prob_period_subs'] ."','". $_POST['int_input_price_prob_period_subs'] ."','". $_POST['res_date_start_sell'] ."','". $_POST['int_price_bilet'] ."','". $_POST['int_old_price_bilet'] ."','". $_POST['res_parse_start_access'] ."',
                    '". $_POST['res_parse_stop_access'] ."','". $_POST['res_parse_stop_sell_bilet'] ."','". $_POST['img_main'] ."','[value-19]','[value-20]','[value-21]', '2024-08-28 15:37:32');";
