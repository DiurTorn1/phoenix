...
Route::get('/product_add', [App\Http\Controllers\ProductPhoenix::class, 'index']);//ProductPhoenix::class .'@index');//->name('Product');//'ProductPhoenix@index');//->name('Product');//function () {// 
