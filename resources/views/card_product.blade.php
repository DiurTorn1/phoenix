		...
		<div class="admin-video-sort justi-sp-b admin-back">
			<div class="admin-input-width50">
					...
					<div class="index-live-banner">
								<img src="img/no-image.jpg" alt="Обложка продукта *" id="upload_main_banner_product">
					</div>
					...
					<!--<a href="" class="add-preview-tournir" title="Загрузить обложку продукта"><img src="{{ asset('img/ivs4.png') }}" alt="Обложка продукта *" id="upload_main_banner_product"></a> </a>-->
