...
<div class="user-text-wrapper">
		...
		<p class="user-text">11.5. Уведомления: Вы должны направлять нам любые уведомления юридического характера по электронной почте <a class="user-link" href="mailto:info-phoenixtv@mail.ru">info-phoenixtv@mail.ru</a>  или по адресу, указанному в главе 12.</p>
		<p class="user-text">12. Автономная некоммерческая физкультурно-спортивная организация «Центр развития спортивных проектов «ФЕНИКС», ОГРН 1237800047870, ИНН 7814822027.</p>
